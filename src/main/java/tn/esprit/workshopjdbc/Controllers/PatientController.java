...
public class PatientController {
    ...
    private final tn.esprit.workshopjdbc.Services.ParticipationService pService = new tn.esprit.workshopjdbc.Services.ParticipationService();
    ...
    private void loadExternalEventSystem() {
        try {
            // This loads your dedicated event list view
